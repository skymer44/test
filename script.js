...
// 📱 PWA Détection et Améliorations iOS
function isPWAMode() {
...
// 📱 Splash Screen PWA
function showPWASplashScreen() {
    if (!isPWAMode()) return;
    
    const splashHTML = `
        <div class="pwa-splash" id="pwa-splash">
            <img src="icons/icon-192x192.svg" alt="Musical 2026" class="app-icon">
            <div class="app-name">Musical 2026</div>
            <div class="app-tagline">Programme Musical 2026</div>
    ...
    // Masquer le splash après le chargement
    window.addEventListener('load', () => {
        ...
        }, 1500); // Afficher pendant au moins 1.5s
    });
}
...
window.addEventListener('beforeinstallprompt', (e) => {
    ...
    // Afficher le badge PWA et le bouton d'installation
    if (!isPWAMode()) {
        showPWABadge();
        showInstallButton();
    }
...
function showPWABadge() {
    ...
    if (badge) {
        ...
        badge.title = 'Cliquer pour installer l\'application';
    }
}
...
// Initialiser le splash screen si nécessaire
if (isPWAMode()) {
    showPWASplashScreen();
}
