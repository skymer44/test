...
function fixPWANavigation() {
    ...
    if (isStandalone) {
        logPWA('Mode PWA détecté - Application des corrections navigation');
        ...
        if (mobileNav) {
            ...
            logPWA('Navigation mobile forcée en position fixe');
        }
        ...
        // Techniques pour masquer le Home Indicator
        ...
        logPWA('Tentative de masquage du Home Indicator iPhone');
    }
}
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (isStandalone) {
        logPWA('Initialisation des optimisations PWA');
        
        // Désactiver les animations CSS complexes en mode PWA pour éviter les problèmes
        const pwaStyles = document.createElement('style');
        pwaStyles.id = 'pwa-optimizations';
        pwaStyles.textContent = `
            /* Optimisations PWA - Animations simplifiées */
            * {
            ...
            /* Scroll plus fluide en PWA */
            html {
                scroll-behavior: auto !important;
            }
            
            /* Éviter les problèmes de repaint */
            .main-next-event,
            .mini-event-card,
            .piece-card {
                will-change: auto;
        ...
        logPWA('Styles d\'optimisation PWA appliqués');
    }
